...
public class SQLiteGameDataManager {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            Map<String, Object> playerData = loadPlayerData(playerId);
            ...
            if (playerData != null) {
                ...
                // 2. 模拟修改数据（这里我们直接在 Java Map 中进行修改）
                System.out.println("\n2. 正在修改数据...");
                playerData.put("最大气血", 999999); // 拉满血量
                playerData.put("名称", "逍遥生_Java"); // 修改名字
...
//                savePlayerData(playerId, playerData);
     ...
     * 从数据库读取并解析玩家数据
     */
    public static Map<String, Object> loadPlayerData(int playerId) throws SQLException, IOException {
        ...
        try (Connection conn = DriverManager.getConnection(DB_URL);
            ...
            try (ResultSet rs = pstmt.executeQuery()) {
                if (rs.next()) {
                    ...
                    return msgpackMapper.readValue(bytes, new TypeReference<Map<String, Object>>() {});
                }
            }
        }
        return null;
